...
from app.api.routes import ai, assets, exports, presentations
from app.core.database import Base, engine
from app.services.presentation_service import NotFoundError
from app.services.asset_service import AssetValidationError
...
async def invalid_asset(_, exc: AssetValidationError):
    return JSONResponse(status_code=400, content={"error": {"code": "INVALID_ASSET", "message": str(exc)}})
