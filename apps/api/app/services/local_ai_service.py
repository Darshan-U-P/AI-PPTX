...
class LocalAIService:
    ...
    async def status(self) -> dict[str, object]:
        try:
            ...
            return {"provider": "localai", "base_url": self.base_url, "reachable": True, "configured_model": self.model, "models": models}
        except httpx.HTTPError:
            return {"provider": "localai", "base_url": self.base_url, "reachable": False, "configured_model": self.model, "models": []}
