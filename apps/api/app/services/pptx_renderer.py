...
from app.schemas.presentation import ImageElement, LineElement, PresentationIR, ShapeElement, TextElement
...
class PPTXRenderer:
    ...
    def render(self, presentation: PresentationIR) -> bytes:
        ...
        for ir_slide in presentation.slides:
    ...
    def _add_element(self, slide, element):
        if isinstance(element, TextElement):
            ...
            shape_type = {"rectangle": MSO_AUTO_SHAPE_TYPE.RECTANGLE, "ellipse": MSO_AUTO_SHAPE_TYPE.OVAL, "round_rect": MSO_AUTO_SHAPE_TYPE.ROUNDED_RECTANGLE}[element.shape_type]
            ...
            line.line.color.rgb = _rgb(element.color)
