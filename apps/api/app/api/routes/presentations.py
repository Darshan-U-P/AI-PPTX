...
from app.services.presentation_service import create_presentation, create_slide, delete_presentation, delete_slide, get_presentation, list_presentations, update_presentation, update_slide
...
@router.get("/presentations", response_model=list[PresentationIR])
def list_all(db: Session = Depends(get_db)):
    return list_presentations(db)
